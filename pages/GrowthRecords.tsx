  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="flex justify-between items-center">
        <h1 className="text-3xl font-black text-slate-800">মাছের বৃদ্ধি</h1>
        <button onClick={() => setIsModalOpen(true)} className="px-6 py-4 bg-indigo-600 text-white rounded-2xl font-black">➕ নতুন রেকর্ড</button>
      </div>
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-6 z-50">
          <div className="bg-white w-full max-w-md rounded-[2.5rem] p-10 space-y-6 shadow-2xl">
            <h3 className="text-2xl font-black text-slate-800 text-center">ওজন লগ করুন</h3>
            ...
            <div className="flex gap-4">
              ...
              <button onClick={handleAdd} className="flex-[2] py-4 bg-indigo-600 text-white rounded-xl font-black">সংরক্ষণ</button>
            </div>
          </div>
        </div>
      )}
