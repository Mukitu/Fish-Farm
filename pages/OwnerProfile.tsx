  ...
  return (
    <div className="min-h-screen bg-white font-['Hind_Siliguri']">
      ...
      <div className="max-w-4xl mx-auto py-16 px-6 text-center">
        ...
        <h1 className="text-4xl md:text-6xl font-black text-slate-900 mb-4">মুুকিতুল ইসলাম নিশাত</h1>
        ...
        <div className="bg-slate-50 p-10 md:p-16 rounded-[4rem] text-left shadow-inner border border-slate-100">
           ...
           <p className="text-slate-600 text-lg leading-relaxed font-medium">
             বাংলাদেশের প্রান্তিক খামারিদের প্রযুক্তিগত সহায়তা দিতে আমি এই প্ল্যাটফর্মটি তৈরি করেছি। আমরা চাই প্রতিটি পুকুরের হিসাব থাকুক স্বচ্ছ এবং প্রত্যেক খামারি যেন নিশ্চিত লাভের মুখ দেখেন।
           </p>
           <div className="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-100">
                 ...
                 <p className="text-xl font-black text-slate-800">ঢাকা, বাংলাদেশ</p>
              </div>
           </div>
        </div>
      </div>
