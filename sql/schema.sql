...
-- Ensure keywords column exists if table was created earlier
DO $$ 
BEGIN 
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='farming_guides' AND column_name='keywords') THEN
        ALTER TABLE public.farming_guides ADD COLUMN keywords TEXT;
    END IF;
END $$;
...
-- Ensure size columns exist in timeline
DO $$ 
BEGIN 
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='farming_timeline' AND column_name='min_size_inch') THEN
        ALTER TABLE public.farming_timeline ADD COLUMN min_size_inch DECIMAL DEFAULT 0;
        ALTER TABLE public.farming_timeline ADD COLUMN max_size_inch DECIMAL DEFAULT 99;
    END IF;
END $$;

-- Ensure avg_size_inch exists in stocking_records
DO $$ 
BEGIN 
    IF NOT EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name='stocking_records' AND column_name='avg_size_inch') THEN
        ALTER TABLE public.stocking_records ADD COLUMN avg_size_inch DECIMAL DEFAULT 0;
    END IF;
END $$;
...
BEGIN
    ...
    IF carp_id IS NOT NULL THEN
        ...
        (carp_id, 1, 'পুকুর প্রস্তুতি ও চুন প্রয়োগ', 'পুকুর শুকানো, তলার কাদা অপসারণ। শতাংশে ১ কেজি চুন ও ৫০০ গ্রাম লবণ প্রয়োগ।', 'চুন, লবণ, ব্লিচিং', 0, 99),
        (carp_id, 2, 'পোনা মজুদ ও প্রাথমিক যত্ন', 'সকালে পোনা অবমুক্ত করা। শতাংশে ৪০টি পোনা (৫-৬ ইঞ্চি)। পোনা ছাড়ার পর ভিটামিন সি প্রয়োগ।', 'পটাশ, ভিটামিন সি', 0, 99),
        (carp_id, 3, 'প্রাকৃতিক খাদ্য উৎপাদন', 'ইউরিয়া ১০০ গ্রাম ও টিএসপি ৫০ গ্রাম শতাংশ প্রতি প্রয়োগ করে পানি সবুজ করা।', 'ইউরিয়া, টিএসপি', 0, 99),
        (carp_id, 4, 'সম্পূরক খাদ্য শুরু', 'মাছের ওজনের ৩% হারে ভাসমান বা ডুবন্ত খাবার প্রদান।', 'এনজাইম', 0, 99),
        (carp_id, 5, 'পানির মান ও অক্সিজেন', 'পানির pH ৭.৫-৮.৫ এর মধ্যে রাখা। ভোরে অক্সিজেন স্বল্পতা হলে এরটর চালানো।', 'অক্সিজেন ট্যাবলেট, জিওলাইট', 0, 99),
        (carp_id, 6, 'মাছের বৃদ্ধি পরীক্ষা', 'নমুনা সংগ্রহ করে ওজন চেক করা। বৃদ্ধি কম হলে খাবারের মান বাড়ানো।', 'গ্রোথ প্রোমোটার', 0, 99),
        (carp_id, 7, 'পরজীবী নিয়ন্ত্রণ', 'মাছের গায়ে উকুন বা লাল দাগ চেক করা। প্রয়োজনে ওষুধ ব্যবহার।', 'ডিপটারেক্স, লবন', 0, 99),
        (carp_id, 8, 'তলার গ্যাস নিয়ন্ত্রণ', 'পুকুরের তলায় গ্যাস জমলে হররা টানা বা গ্যাস ট্র্যাপ ব্যবহার।', 'গ্যাস ট্র্যাপ', 0, 99),
        (carp_id, 9, 'শীতকালীন প্রস্তুতি', 'শীতের আগে পানির গভীরতা বাড়ানো এবং চুন প্রয়োগ করা।', 'চুন, পটাশ', 0, 99),
        (carp_id, 10, 'আংশিক আহরণ', 'বড় মাছগুলো (৮০০ গ্রাম+) বাজারজাত করা।', 'N/A', 0, 99),
        (carp_id, 11, 'বাজারজাতকরণ', 'মাছের সঠিক দাম যাচাই করে পাইকারি বাজারে যোগাযোগ।', 'N/A', 0, 99),
        (carp_id, 12, 'চূড়ান্ত আহরণ ও শুকানো', 'সব মাছ ধরে পুকুর শুকিয়ে পরবর্তী চাষের জন্য প্রস্তুত করা।', 'N/A', 0, 99);
    END IF;

    IF tilapia_id IS NOT NULL THEN
        INSERT INTO public.farming_timeline (guide_id, month_number, task_title, task_description, medicine_suggestions, min_size_inch, max_size_inch) VALUES
        (tilapia_id, 1, 'পুকুর প্রস্তুতি ও পোনা', 'পুকুর শুকানো, চুন প্রয়োগ (১ কেজি/শতাংশ) এবং শতাংশে ২৫০টি মনোসেক্স পোনা মজুদ।', 'চুন, পটাশ', 0, 99),
        (tilapia_id, 2, 'উচ্চ প্রোটিন খাদ্য', '৩০-৩৫% প্রোটিন সমৃদ্ধ ভাসমান খাবার। দিনে ২ বার। মোট ওজনের ৫% খাবার।', 'এনজাইম, ভিটামিন সি', 0, 99),
        (tilapia_id, 3, 'পানির স্বচ্ছতা ও গ্যাস', 'পানির রঙ গাঢ় সবুজ হলে খাবার কমিয়ে দেয়া। তলার গ্যাস চেক করা।', 'জিওলাইট, গ্যাস ট্র্যাপ', 0, 99),
        (tilapia_id, 4, 'আংশিক আহরণ', 'মাছ ২০০-২৫০ গ্রাম হলে বড়গুলো বিক্রি শুরু করা।', 'N/A', 0, 99),
        (tilapia_id, 5, 'চূড়ান্ত আহরণ', '৫ মাস পূর্ণ হলে সব মাছ ধরে ফেলা এবং নতুন চাষের প্রস্তুতি।', 'N/A', 0, 99),
        (tilapia_id, 6, 'পুকুর সংস্কার', 'পরবর্তী চাষের জন্য পুকুর শুকানো।', 'চুন', 0, 99);
    END IF;

    IF pangas_id IS NOT NULL THEN
        INSERT INTO public.farming_timeline (guide_id, month_number, task_title, task_description, medicine_suggestions, min_size_inch, max_size_inch) VALUES
        (pangas_id, 1, 'পুকুর প্রস্তুতি', 'গভীর পুকুর নির্বাচন (৫-৬ ফুট পানি)। শতাংশে ২০০টি পোনা মজুদ।', 'চুন, লবন', 0, 99),
        (pangas_id, 2, 'খাদ্য ব্যবস্থাপনা', 'মাছের ওজনের ৫% হারে খাবার প্রদান। প্রোটিন ২৫-২৮%।', 'ভিটামিন এডি৩ই', 0, 99),
        (pangas_id, 3, 'পানির মান', 'অ্যামোনিয়া গ্যাস নিয়ন্ত্রণে রাখা। নিয়মিত পানি পরিবর্তন।', 'অ্যামোনিয়াম ট্র্যাপ, জিওলাইট', 0, 99),
        (pangas_id, 4, 'বৃদ্ধি পর্যবেক্ষণ', 'মাছ দ্রুত বাড়ে, তাই নিয়মিত নমুনা সংগ্রহ করা।', 'এনজাইম', 0, 99),
        (pangas_id, 5, 'রোগ প্রতিরোধ', 'পাঙ্গাসের লেজ পচা রোগ প্রতিরোধে সতর্ক থাকা।', 'বিকেসি (BKC)', 0, 99),
        (pangas_id, 6, 'আহরণ শুরু', 'মাছ ৫০০-৬০০ গ্রাম হলে বাজারজাত শুরু করা যায়।', 'N/A', 0, 99);
    END IF;
