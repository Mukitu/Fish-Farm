...
BEGIN
    ...
    IF carp_id IS NOT NULL THEN
        ...
        (carp_id, 1, 'পুকুর প্রস্তুতি ও চুন প্রয়োগ', 'পুকুর শুকানো, তলার কাদা অপসারণ। শতাংশে ১ কেজি চুন ও ৫০০ গ্রাম লবণ প্রয়োগ।', 'চুন, লবণ, ব্লিচিং'),
        (carp_id, 2, 'পোনা মজুদ ও প্রাথমিক যত্ন', 'সকালে পোনা অবমুক্ত করা। শতাংশে ৪০টি পোনা (৫-৬ ইঞ্চি)। পোনা ছাড়ার পর ভিটামিন সি প্রয়োগ।', 'পটাশ, ভিটামিন সি'),
        (carp_id, 3, 'প্রাকৃতিক খাদ্য উৎপাদন', 'ইউরিয়া ১০০ গ্রাম ও টিএসপি ৫০ গ্রাম শতাংশ প্রতি প্রয়োগ করে পানি সবুজ করা।', 'ইউরিয়া, টিএসপি'),
        (carp_id, 4, 'সম্পূরক খাদ্য শুরু', 'মাছের ওজনের ৩% হারে ভাসমান বা ডুবন্ত খাবার প্রদান।', 'এনজাইম'),
        (carp_id, 5, 'পানির মান ও অক্সিজেন', 'পানির pH ৭.৫-৮.৫ এর মধ্যে রাখা। ভোরে অক্সিজেন স্বল্পতা হলে এরটর চালানো।', 'অক্সিজেন ট্যাবলেট, জিওলাইট'),
        (carp_id, 6, 'মাছের বৃদ্ধি পরীক্ষা', 'নমুনা সংগ্রহ করে ওজন চেক করা। বৃদ্ধি কম হলে খাবারের মান বাড়ানো।', 'গ্রোথ প্রোমোটার'),
        (carp_id, 7, 'পরজীবী নিয়ন্ত্রণ', 'মাছের গায়ে উকুন বা লাল দাগ চেক করা। প্রয়োজনে ওষুধ ব্যবহার।', 'ডিপটারেক্স, লবন'),
        (carp_id, 8, 'তলার গ্যাস নিয়ন্ত্রণ', 'পুকুরের তলায় গ্যাস জমলে হররা টানা বা গ্যাস ট্র্যাপ ব্যবহার।', 'গ্যাস ট্র্যাপ'),
        (carp_id, 9, 'শীতকালীন প্রস্তুতি', 'শীতের আগে পানির গভীরতা বাড়ানো এবং চুন প্রয়োগ করা।', 'চুন, পটাশ'),
        (carp_id, 10, 'আংশিক আহরণ', 'বড় মাছগুলো (৮০০ গ্রাম+) বাজারজাত করা।', 'N/A'),
        (carp_id, 11, 'বাজারজাতকরণ', 'মাছের সঠিক দাম যাচাই করে পাইকারি বাজারে যোগাযোগ।', 'N/A'),
        (carp_id, 12, 'চূড়ান্ত আহরণ ও শুকানো', 'সব মাছ ধরে পুকুর শুকিয়ে পরবর্তী চাষের জন্য প্রস্তুত করা।', 'N/A');
    END IF;
    ...
    IF tilapia_id IS NOT NULL THEN
        ...
        (tilapia_id, 2, 'উচ্চ প্রোটিন খাদ্য', '৩০-৩৫% প্রোটিন সমৃদ্ধ ভাসমান খাবার। দিনে ২ বার। মোট ওজনের ৫% খাবার।', 'এনজাইম, ভিটামিন সি'),
